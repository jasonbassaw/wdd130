...
const hikes = [
   ...
   simpleList.sort(); // Sort alphabetically
   console.log(simpleList);
   
   simpleList.reverse(); // Reverse the sorted list
   console.log(simpleList);
   ...
   console.log(searchList(simpleList, "b"));  // Search for "b"
   console.log(searchList(simpleList, "an")); // Search for "an"
...
FilteredList = searchList(hikes, "al");
